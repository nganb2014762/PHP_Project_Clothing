        ...
        <div class="order-lg-2">
            <div class="navbar-collapse nav-btns">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    // session_start();
                    // $select_profile = $pdo->prepare("SELECT * FROM `user` WHERE role = '0' ");
                    ...
                    //                 <i class="fa-solid fa-user"></i> <span>' . $fetch_profile['name'] . '</span>
                    //             </a>
                    ...
                    if (isset($_SESSION['user_id'])) {
                        ...
                        // Now, $fetch_profile contains the user's data
                        echo ' <div class="dropdown">
                                <a  style="color:#222; text-decoration: none;" href="#" role="button" data-bs-toggle="dropdown">
                                    <i class="fa-solid fa-user"></i> <span>' . $fetch_profile['name'] . '</span>
                                </a>
