...
<div class="container my-5 py-5 ">
    <div class="container title text-center mt-3 pt-5">
        <h2 class="position-relative d-inline-block">Why choose us?</h2>
        <hr class="mx-auto">
    </div>
    <br>
    ...
    <div class="row">
        <div class="col-6 col-md-4">
            ...
            <p>I'm absolutely in love with my new dress from FASHION! The quality is outstanding and it fits perfectly.
                Can't wait to shop here again!</p>
        </div>
        ...
        <div class="col-6 col-md-4">
            ...
            <p>The customer service at FASHION is top-notch! They were so helpful in helping me find the perfect outfit
                for
                event. Thank you!</p>
        </div>
